'''
Create quiz for 35 sudents with 50 ques each
'''
import random
...
for numquiz in range(35):
    # quiz file
    quizfile = open('C:/Users/dell/PycharmProjects/test/venv/Lib/quiz/quiz questions/'+str(numquiz+1)+".txt",'w')

    # answers file
    answerskeyfile = open('C:/Users/dell/PycharmProjects/test/venv/Lib/quiz/quiz answers/quizanswers'+str(numquiz+1)+".txt",'w')
